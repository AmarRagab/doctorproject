      ...
      >
        ...
        <div id="search-form" className="col-md-12 mt-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
            <select
  className="w-full border rounded-md p-2 sm:text-base text-sm focus:outline-none focus:ring focus:border-blue-300 transition duration-300"
  name="cat"
  id="cat"
  ...
  <div className="flex justify-center overflow-x-scroll space-x-0 py-2">
    {city.map((region, index) => (
      <div className="group relative cursor-pointer flex-none" key={index}>
        <button
          className={`block py-1 px-1.5 sm:px-4 text-gray-500 hover:text-blue-500 hover:bg-blue-50 transition duration-300 focus:outline-none rounded-lg ${
            thisregion === region ? "text-blue-500" : ""
          }`}
          id={"tab" + index}
